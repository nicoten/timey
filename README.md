...
A macOS menu bar time tracker built with [Tauri v2](https://tauri.app), React, and SQLite (data stays local).
...
The month reads as a shaded grid — one circle per day, deeper the longer the day — with the month's hours and earnings in the header and a single day's figures on hover.
